            ...
            public void onClick(View v) {
                if (ShareDialog.canShow(ShareLinkContent.class)){
                    ShareLinkContent linkContent = new ShareLinkContent.Builder()
                            ...
                            .setContentDescription("Aplikasi Math Learn ini dikembangkan dengan bantuan tim Polostod Developers ini ditujukan kepada anak - anak untuk sarana belajar dasar menghitung sambil bermain." +
