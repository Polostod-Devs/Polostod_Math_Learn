package com.polostod.math.QuestionHard;
 ...
 */
public class Hard extends Activity implements View.OnClickListener {
    ...
    public static final String level = "Hard";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questList = db.getQuestionHard();  // this will fetch all quetonall questions
